...
class WorkflowEfficiencyTest(unittest.TestCase):
    def test_e0003_r3_r5_builder_chains_and_validation_ownership(self) -> None:
        ...
        self.assertIn("at most three changed-tree whole-batch repair-and-rerun rounds", normalized_ticket_build)
        self.assertIn("stop only if the third round still fails", normalized_ticket_build)
        ...
        self.assertIn(
            "at most three changed-tree whole-batch repair-and-rerun rounds",
            normalized_economy,
        )
